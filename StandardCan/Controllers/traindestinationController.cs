...
{
    public class traindestinationController : ApiController
    {
        // GET api/<controller>
        ...
        // POST api/<controller>
        public HttpResponseMessage Post([FromBody] traindestinationModel value)
        {
            if (value == null) return null;
            JavaScriptSerializer js = new JavaScriptSerializer();

            traindestinationService service = new traindestinationService();
