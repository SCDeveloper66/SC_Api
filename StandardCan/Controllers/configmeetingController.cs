...
{
    public class configmeetingController : ApiController
    {
        // GET api/<controller>
        ...
        // POST api/<controller>
        public HttpResponseMessage Post([FromBody] configmeetingModel value)
        {
            if (value == null) return null;
            JavaScriptSerializer js = new JavaScriptSerializer();

            configmeetingService service = new configmeetingService();
