        ...
        public messageModel insert(roomModel value)
        {
            ...
            try
            {
                ...
                using (var context = new StandardCanEntities())
                {
                    ...
                    int ret = context.sp_room_insert(value.code, value.name, value.color, userId, myOutputParamInt);
                }
        ...
        public messageModel update(roomModel value)
        {
            ...
            try
            {
                using (var context = new StandardCanEntities())
                {
                    ...
                    int ret = context.sp_room_update(value.id, value.code, value.name, value.color, userId);
                }
