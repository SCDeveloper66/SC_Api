...
namespace StandardCan.Service
{
    ...
    {
        public IEnumerable<sp_expert_search_Result> search(expertModel value)
        {
            try
            {
                ...
                IEnumerable<sp_expert_search_Result> result = context.sp_expert_search(value.name).AsEnumerable();
                return result;
            }
            catch (Exception ex)
            {
        ...
        public messageModel insert(expertModel value)
        {
            ...
            try
            {
                ...
                using (var context = new StandardCanEntities())
                {
                    ...
                    int ret = context.sp_expert_insert(value.name,value.tel, userId, myOutputParamInt);
                }
        ...
        public messageModel update(expertModel value)
        {
            messageModel result = new messageModel();
            ...
            try
            {
                using (var context = new StandardCanEntities())
                {
                    ...
                    int ret = context.sp_expert_update(value.id,value.name, value.tel, userId);
                }
        ...
        public messageModel delete(expertModel value)
        {
            messageModel result = new messageModel();
            ...
            try
            {
                using (var context = new StandardCanEntities())
                {
                    ...
                    int ret = context.sp_expert_delete(value.id, userId);
                }
