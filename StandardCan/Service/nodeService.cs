...
namespace StandardCan.Service
{
    public class nodeService
    {
        ...
        public IEnumerable<sp_note_search_Result> search(nodeModel value)
        {
            try
            {
                ...
                IEnumerable<sp_note_search_Result> result = context.sp_note_search(userId).AsEnumerable();
                return result;
            }
            catch (Exception ex)
            {
        ...
        public messageModel insert(nodeModel value)
        {
            ...
            try
            {
                ...
                using (var context = new StandardCanEntities())
                {
                    ...
                    int ret = context.sp_node_insert(value.ip, value.name, value.ref_id, userId, myOutputParamInt);
                }
        ...
        public messageModel update(nodeModel value)
        {
            ...
            try
            {
                using (var context = new StandardCanEntities())
                {
                    ...
                    int ret = context.sp_node_update(value.id, value.ip, value.name, value.ref_id, userId);
                }
        ...
        public messageModel delete(nodeModel value)
        {
            ...
            try
            {
                using (var context = new StandardCanEntities())
                {
                    ...
                    int ret = context.sp_node_delete(value.id, userId);
                }
